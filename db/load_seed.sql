...
LOAD DATA LOCAL INFILE 'planning_lines.csv' INTO TABLE planning_lines
  FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' LINES TERMINATED BY '\n'
  IGNORE 1 LINES
...
LOAD DATA LOCAL INFILE 'purchase_orders.csv' INTO TABLE purchase_orders
  FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' LINES TERMINATED BY '\n'
  IGNORE 1 LINES
...
LOAD DATA LOCAL INFILE 'po_payments.csv' INTO TABLE po_payments
  FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' LINES TERMINATED BY '\n'
  IGNORE 1 LINES
...
LOAD DATA LOCAL INFILE 'po_payment_terms.csv' INTO TABLE po_payment_terms
  FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' LINES TERMINATED BY '\n'
  IGNORE 1 LINES
  (id, purchase_order_id, seq, label, pct, kind, is_holdback);

LOAD DATA LOCAL INFILE 'replenishments.csv' INTO TABLE replenishments
  FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' LINES TERMINATED BY '\n'
  IGNORE 1 LINES
...
LOAD DATA LOCAL INFILE 'cash_advances.csv' INTO TABLE cash_advances
  FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' LINES TERMINATED BY '\n'
  IGNORE 1 LINES
...
LOAD DATA LOCAL INFILE 'additional_payments.csv' INTO TABLE additional_payments
  FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' LINES TERMINATED BY '\n'
  IGNORE 1 LINES
...
LOAD DATA LOCAL INFILE 'payroll_periods.csv' INTO TABLE payroll_periods
  FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' LINES TERMINATED BY '\n'
  IGNORE 1 LINES
  (id, project_id, label, period_start, period_end, status, total_amount);

LOAD DATA LOCAL INFILE 'workers.csv' INTO TABLE workers
  FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' LINES TERMINATED BY '\n'
  IGNORE 1 LINES
...
LOAD DATA LOCAL INFILE 'payroll_entries.csv' INTO TABLE payroll_entries
  FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' LINES TERMINATED BY '\n'
  IGNORE 1 LINES
...
LOAD DATA LOCAL INFILE 'weekly_budget_additions.csv' INTO TABLE weekly_budget_additions
  FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' LINES TERMINATED BY '\n'
  IGNORE 1 LINES
